...
#include <spsInteractorStyleTouchPaintBrush.h>

vtkStandardNewMacro(spsInteractorStyleTouchPaintBrush);

//------------------------------------------------------------------------------
spsInteractorStyleTouchPaintBrush::spsInteractorStyleTouchPaintBrush()
{
...
//------------------------------------------------------------------------------
void spsInteractorStyleTouchPaintBrush::OnLeftButtonDown()
{
...
//------------------------------------------------------------------------------
void spsInteractorStyleTouchPaintBrush::OnLeftButtonUp()
{
  vtkDebugMacro("" << __FUNCTION__);
...
//------------------------------------------------------------------------------
void spsInteractorStyleTouchPaintBrush::OnMouseMove()
{
  vtkDebugMacro("" << __FUNCTION__);
  vtkRenderer* renderer = this->Interactor->GetRenderWindow()->GetRenderers()->GetFirstRenderer();
  if (!renderer)
...
//------------------------------------------------------------------------------
bool spsInteractorStyleTouchPaintBrush::ActorHasColors(vtkActor* actor)
{
  vtkDebugMacro("" << __FUNCTION__);
  vtkPolyData* polyData = vtkPolyData::SafeDownCast(actor->GetMapper()->GetInput());
...
//------------------------------------------------------------------------------
void spsInteractorStyleTouchPaintBrush::AddInitialColor(vtkActor* actor, vtkPolyData* polyData)
{
  vtkDebugMacro("" << __FUNCTION__);
...
//------------------------------------------------------------------------------
void spsInteractorStyleTouchPaintBrush::ApplyBrush(
