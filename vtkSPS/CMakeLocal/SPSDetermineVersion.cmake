...
#  All rights reserved.
#  See Copyright.txt or http://www.github.com/JensMunkHansen/vtkSps/Copyright.html for details.
#
...
# Used to determine the version for SPS source using "git describe", if git
...
#   var_prefix : prefix for variables e.g. "SPS".
function(determine_version source_dir git_command var_prefix)
  if ("$Format:$" STREQUAL "")
    ...
    # this function.
    return ()
  elseif (NOT SPS_GIT_DESCRIBE AND
    ...
    if (NOT result EQUAL "0")
      message("get describe failed")
      # git describe failed (bad return code).
      set(output "")
    endif()
  else ()
    # note, output may be set to empty if SPS_GIT_DESCRIBE is not defined.
    set(output "${SPS_GIT_DESCRIBE}")
  endif()
