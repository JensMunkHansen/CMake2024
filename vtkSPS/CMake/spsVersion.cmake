...
set(SPS_VERSION "${SPS_SHORT_VERSION}.${SPS_BUILD_VERSION}")

set(sps_version_suffix "")
if (SPS_VERSIONED_INSTALL)
  set(sps_version_suffix "-${SPS_SHORT_VERSION}")
endif ()

set(SPS_TWEAK_VERSION ${timestring})
set(SPS_BUILD_VERSION 1)#${SPS_TWEAK_VERSION})
set(SPS_VERSION_FULL "${SPS_MAJOR_VERSION}.${SPS_MINOR_VERSION}.${SPS_BUILD_VERSION}")
